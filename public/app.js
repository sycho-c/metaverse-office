...
import {
  floorW, floorH, rooms, seatMap, walkers, speeches, speechOn, setSpeechOn,
...
// ---------- 월드 시뮬레이션 (world.mjs) ----------
import {
  rebuildWorld, blocked, ensureWalker, drawWalkPerson,
...
// ---------- 불변 상수 → constants.mjs ----------
import {
  DISP, POD_W, POD_H, AISLE_X, AISLE_Y, WALL, TOP_WALL, ZONE_H, CORRIDOR_H, ROAM_TOP,
